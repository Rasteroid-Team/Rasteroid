...
public class CirclePlayer extends PlayerModel {

  private final String res_path = "Game/src/main/java/View/test/Resources/players/circlePlayer/";
  ...
  public void load_states()
  {
    ...
    MachineState down = new MachineState("down");
    {
      ...
      down_sprites[0] = new Sprite(res_path+"down/hr75_idle_1.png").load().resize(200,200);
      //
